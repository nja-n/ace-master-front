...
export default function UserCard({ user, isTop10 }) {

  const [connectClcked, setConnectClicked] = useState(false);
  ...
  return (
    <>
      ...
      <EmailConnect
        open={connectClcked}
        onClose={() => setConnectClicked(false)}
        userId={user.id}
      />
    </>
  );
